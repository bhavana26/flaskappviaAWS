...
@app.route("/")
def hello():
    result = execute_query("Create table IF NOT EXISTS users (username varchar(255), password varchar(255),firstname varchar(255),lastname varchar(255),email varchar(255),count int)")
